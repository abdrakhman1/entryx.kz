<form action="/feedback_submit" method="POST" id="feedback_form">
                @csrf
                <div class="inputs">
                  <div class="input">
                    ...
                    <input
                      ...
                      id="name"
                      name="name"
                      placeholder="Введите ФИО" value="{{ old('name') }}"/>
                      @error('name')
                  ...
                  <div class="input">
                    ...
                    <input
                      ...
                      id="bin"
                      name="bin"
                      placeholder="Введите БИН" value="{{ old('bin') }}"
                    /> @error('bin')
                         <small class="text-danger">{{ $message }}</small>
                    @enderror
                  </div>
                  <div class="input">
                    ...
                    >
                      ...
                      <input
                        ...
                        id="phone"
                        name="phone"
                        placeholder="+7 (999) 999 99 99" value="{{ old('phone') }}"
                      />  @error('phone')
                     <small class="text-danger">{{ $message }}</small>
                    @enderror
                  </div>
